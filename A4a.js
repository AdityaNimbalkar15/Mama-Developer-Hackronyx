...
(function () {
    ...
    /******************* Prompts **************************/
    const notesPrompt = transcript => `You are a top‑tier technical instructor. Create smart, structured notes from this transcript.\n\n- Begin with a **1‑line summary** of the core topic.\n- Break down concepts with **bullet points**, highlighting key terms in **bold**.\n- Add brief real‑world **use‑case** examples where relevant.\n- For any process, include a **flow chart** using arrows (e.g., A → B → C).\n\nTranscript:\n"""\n${transcript}\n"""`;
